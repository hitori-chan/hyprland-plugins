...
namespace NHyprnotify {
    ...
    struct SNotifyConfig {
        ...
        SP<Config::Values::CColorValue>  colSurface;    // opaque notification/row container
    ...
    struct SHover {
        ...
        int          btn  = -1;
        // 0 body, 3 reply field, 4 send, 6 manage Done,
        // 7 manage Dismiss, 8 undo,
        // 16+n a manage panel entry
        uint8_t      part = 0;
